...
public class MakeMyTrip 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"SW\"]/div[1]/div[2]/div[2]/div/section/span"))).click();
		driver.findElement(By.xpath("//span[text()='From']")).click();
		Thread.sleep(2000);
		WebElement src=driver.findElement(By.xpath("//*[@id=\"fromCity\"]"));
		src.sendKeys("Mumbai");
		Thread.sleep(2000);
